...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { nomealuno: @aluno.nomealuno, nomemae: @aluno.nomemae, nomepai: @aluno.nomepai, telefone3: @aluno.telefone3, telmae: @aluno.telmae, telpai: @aluno.telpai }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { nomealuno: @aluno.nomealuno, nomemae: @aluno.nomemae, nomepai: @aluno.nomepai, telefone3: @aluno.telefone3, telmae: @aluno.telmae, telpai: @aluno.telpai }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
